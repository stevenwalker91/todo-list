...
/* harmony export */   "displayNewProjectDialog": () => (/* binding */ displayNewProjectDialog),
/* harmony export */   "getFormInputs": () => (/* binding */ getFormInputs),
/* harmony export */   "handleAccordion": () => (/* binding */ handleAccordion),
/* harmony export */   "handleMobileMenu": () => (/* binding */ handleMobileMenu),
...
const addProjectsToTaskForm = () => {
  ...
  const listOfProjects = _projects__WEBPACK_IMPORTED_MODULE_0__.projectList;
  const elements = [];
...
const formatDate = (date) => {
  ...
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskDate, baseDate, { addSuffix: true });
};
...
const loadExistingTaskInForm = (id) => {
  const taskToUpdate = _tasks__WEBPACK_IMPORTED_MODULE_1__.getSingleTask(id);
...
const loadTasks = (project) => {
  ...
  const listOfTasks = _tasks__WEBPACK_IMPORTED_MODULE_1__.getTasks(currentView, project);
  ...
  listOfTasks.forEach((task) => {
    ...
    checkBox.addEventListener("change", (event) => {
      if (event.target.checked) {
        _tasks__WEBPACK_IMPORTED_MODULE_1__.updateTaskStatus(task.id, true);
      } else {
        _tasks__WEBPACK_IMPORTED_MODULE_1__.updateTaskStatus(task.id, false);
      }
    ...
    dateContainer.setAttribute("title", (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate));
    ...
    deleteBtn.addEventListener("click", (event) => {
      if (
        ...
        _tasks__WEBPACK_IMPORTED_MODULE_1__.deleteTask(event.target.dataset.itemid);
        loadTasks();
      }
    });
...
const loadProjects = () => {
  ...
  listOfProjects.forEach((project) => {
    ...
    crossSpan.addEventListener("click", (event) => {
      ...
      _projects__WEBPACK_IMPORTED_MODULE_0__.deleteProject(event.target.parentElement.dataset.projectid);
...
const createNewProject = () => {
  ...
  _projects__WEBPACK_IMPORTED_MODULE_0__.newProject(inputProject.value);
  loadProjects();
  inputProject.value = "";
};
...
window.addEventListener("load", () => {
  _display__WEBPACK_IMPORTED_MODULE_0__.loadProjects();
  ...
  primaryMenuItems.forEach((item) => {
    item.addEventListener("click", (event) => {
      ...
      _display__WEBPACK_IMPORTED_MODULE_0__.updateCurrentView(target.dataset.display);
      // check if clicked item has a project ID, in which case pass it to the load tasks function
      if (target.dataset.projectid) {
        _display__WEBPACK_IMPORTED_MODULE_0__.loadTasks(target.dataset.projectid);
      } else {
        _display__WEBPACK_IMPORTED_MODULE_0__.loadTasks();
      }

      _display__WEBPACK_IMPORTED_MODULE_0__.updateActiveMenuItem(item);
      _display__WEBPACK_IMPORTED_MODULE_0__.updatePageHeader(target.dataset.header);
      ...
      if (menuOptions.classList.contains("mobile-nav")) {
        _display__WEBPACK_IMPORTED_MODULE_0__.handleMobileMenu();
      }
    });
  });
});
...
document.addEventListener("keydown", (event) => {
  ...
  if (event.target.id === "projectNameInput") {
    switch (enteredChar) {
      case "Escape":
        _display__WEBPACK_IMPORTED_MODULE_0__.displayNewProjectDialog();
        break;
      case "Enter":
        _display__WEBPACK_IMPORTED_MODULE_0__.displayNewProjectDialog();
        _display__WEBPACK_IMPORTED_MODULE_0__.createNewProject();
        break;
      default:
        break;
    }
  ...
  switch (enteredChar) {
    case "Escape":
      _display__WEBPACK_IMPORTED_MODULE_0__.closeModal();
      break;
    case "n":
      _display__WEBPACK_IMPORTED_MODULE_0__.displayModal();
      break;
    case "+":
      _display__WEBPACK_IMPORTED_MODULE_0__.displayModal();
      break;
...
newTaskBtn.addEventListener("click", () => {
  _display__WEBPACK_IMPORTED_MODULE_0__.addFormType("new");
  _display__WEBPACK_IMPORTED_MODULE_0__.addProjectsToTaskForm();
  _display__WEBPACK_IMPORTED_MODULE_0__.displayModal();
});

// listen for users closing the modal (they can also use keyboard shortcut)
const closeModalBtn = document.getElementById("closeModal");
closeModalBtn.addEventListener("click", _display__WEBPACK_IMPORTED_MODULE_0__.closeModal);

const cancelBtn = document.getElementById("cancel-task");
cancelBtn.addEventListener("click", () => {
  _display__WEBPACK_IMPORTED_MODULE_0__.closeModal();
  _display__WEBPACK_IMPORTED_MODULE_0__.clearModal();
});
...
form.addEventListener("submit", (event) => {
  ...
  const formInputs = _display__WEBPACK_IMPORTED_MODULE_0__.getFormInputs();

  if (form.dataset.formtype === "new") {
    // spread operator means i can just through all the inputs in a oner
    _tasks__WEBPACK_IMPORTED_MODULE_1__.newTask(...formInputs);
    ...
    _tasks__WEBPACK_IMPORTED_MODULE_1__.editTask(...formInputs);
  }
...
accordionBtn.addEventListener("click", _display__WEBPACK_IMPORTED_MODULE_0__.handleAccordion);

// when clicking new project, show the dialog
const newProjectBtn = document.getElementById("add-project");
newProjectBtn.addEventListener("click", _display__WEBPACK_IMPORTED_MODULE_0__.displayNewProjectDialog);

// when clicking cancel, hide the dialog
const cancelProjectBtn = document.getElementById("cancel-project");
cancelProjectBtn.addEventListener("click", _display__WEBPACK_IMPORTED_MODULE_0__.displayNewProjectDialog);
...
const newProject = (title, description, type) => {
  ...
  const projectsWithTitle = projectList.filter(
  ...
  const project = Project(title, description, type);
...
const getTasks = (filter, project) => {
  ...
  if (filter === "today") {
    return tasksList
      .filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(task.dueDate)))
  ...
  if (filter === "expired") {
    return tasksList
      .filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(task.dueDate)))
      .sort(sortByUncompleted);
  }

  if (filter === "week") {
    return tasksList
      .filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate)))
      .sort(sortByUncompleted);
  }
